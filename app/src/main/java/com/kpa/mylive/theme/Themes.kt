...
private val MyLiveDarkPalette = darkColors(
    primary = Blue200,
...
private val MyLiveLightPalette = lightColors(
    primary = Blue500,
...
fun MyLiveTheme(
    ...
    val myColors = colors ?: if (isDarkTheme) MyLiveDarkPalette else MyLiveLightPalette

    MaterialTheme(
        colors = myColors,
        content = content,
        typography = MyLiveTypography,
        shapes = MyLiveShapes
    )
}
